from utils import Binomial, black_scholes_call_price
...
N = 2000 # we simulate binmial model with N from 1 - 100
...
plt.plot(xs, [Binomial('C', K, T, S0, sigma, r, q, n, 'E')[0] for n in tqdm(xs)], label='binomial modeled call price', alpha=0.5, fontsize=fontsize)
